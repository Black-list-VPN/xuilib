...
from ...models.post_panel_api_inbounds_bulk_del_body import PostPanelApiInboundsBulkDelBody
from ...models.post_panel_api_inbounds_bulk_del_response_200 import PostPanelApiInboundsBulkDelResponse200
from ...xui_types import Response


def _get_kwargs(
    *,
    body: PostPanelApiInboundsBulkDelBody,
) -> dict[str, Any]:
