...
from ...models.post_panel_api_inbounds_push_client_traffics_body import PostPanelApiInboundsPushClientTrafficsBody
...
def _get_kwargs(
    *,
    body: PostPanelApiInboundsPushClientTrafficsBody,
) -> dict[str, Any]:
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = PostPanelApiInboundsPushClientTrafficsResponse200.from_dict(response.json())
