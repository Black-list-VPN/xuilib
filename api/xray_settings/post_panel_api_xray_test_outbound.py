...
def _get_kwargs(
    *,
    body: PostPanelApiXrayTestOutboundBody,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/panel/api/xray/testOutbound",
    }
...
) -> PostPanelApiXrayTestOutboundResponse200 | None:
    if response.status_code == 200:
        response_200 = PostPanelApiXrayTestOutboundResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[PostPanelApiXrayTestOutboundResponse200]:
    return Response(
