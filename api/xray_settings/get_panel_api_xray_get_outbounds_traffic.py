...
def _get_kwargs() -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/panel/api/xray/getOutboundsTraffic",
    }
...
) -> GetPanelApiXrayGetOutboundsTrafficResponse200 | None:
    if response.status_code == 200:
        response_200 = GetPanelApiXrayGetOutboundsTrafficResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetPanelApiXrayGetOutboundsTrafficResponse200]:
    return Response(
