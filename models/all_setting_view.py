...
T = TypeVar("T", bound="AllSettingView")


@_attrs_define
class AllSettingView:
    ...
    flags so the UI can show configured/not configured state.
        ...
        Attributes:
            ...
            has_api_token (bool):
            has_ldap_password (bool):
            has_nord_secret (bool):
            has_smtp_password (bool):
            has_tg_bot_token (bool):
            has_two_factor_token (bool):
            has_warp_secret (bool):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        has_ldap_password = self.has_ldap_password

        has_nord_secret = self.has_nord_secret

        has_smtp_password = self.has_smtp_password

        has_tg_bot_token = self.has_tg_bot_token

        has_two_factor_token = self.has_two_factor_token

        has_warp_secret = self.has_warp_secret
        ...
        field_dict.update(
            {
                ...
                "hasApiToken": has_api_token,
                "hasLdapPassword": has_ldap_password,
                "hasNordSecret": has_nord_secret,
                "hasSmtpPassword": has_smtp_password,
                "hasTgBotToken": has_tg_bot_token,
                "hasTwoFactorToken": has_two_factor_token,
                "hasWarpSecret": has_warp_secret,
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        has_api_token = d.pop("hasApiToken")

        has_ldap_password = d.pop("hasLdapPassword")

        has_nord_secret = d.pop("hasNordSecret")

        has_smtp_password = d.pop("hasSmtpPassword")

        has_tg_bot_token = d.pop("hasTgBotToken")

        has_two_factor_token = d.pop("hasTwoFactorToken")

        has_warp_secret = d.pop("hasWarpSecret")
        ...
        all_setting_view = cls(
            ...
            has_ldap_password=has_ldap_password,
            has_nord_secret=has_nord_secret,
            has_smtp_password=has_smtp_password,
            has_tg_bot_token=has_tg_bot_token,
            has_two_factor_token=has_two_factor_token,
            has_warp_secret=has_warp_secret,
        ...
        all_setting_view.additional_properties = d
        return all_setting_view
