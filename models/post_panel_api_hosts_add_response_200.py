...
T = TypeVar("T", bound="PostPanelApiHostsAddResponse200")


@_attrs_define
class PostPanelApiHostsAddResponse200:
    """
    Attributes:
        success (bool | Unset):
        msg (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_panel_api_hosts_add_response_200 = cls(
            success=success,
            msg=msg,
            obj=obj,
        )

        post_panel_api_hosts_add_response_200.additional_properties = d
        return post_panel_api_hosts_add_response_200
