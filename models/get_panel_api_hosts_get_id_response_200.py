...
T = TypeVar("T", bound="GetPanelApiHostsGetIdResponse200")


@_attrs_define
class GetPanelApiHostsGetIdResponse200:
    """
    Attributes:
        success (bool | Unset):
        msg (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_panel_api_hosts_get_id_response_200 = cls(
            success=success,
            msg=msg,
            obj=obj,
        )

        get_panel_api_hosts_get_id_response_200.additional_properties = d
        return get_panel_api_hosts_get_id_response_200
